...
import com.shpp.p2p.cs.ilitvinov.assignment17.huffman.posthuffman.huffmantree.HuffmanTree;
import com.shpp.p2p.cs.ilitvinov.assignment17.huffman.posthuffman.huffmantree.Node;
...
public class Packer implements ArchiverConstants {
    ...
    public long pack() throws Exception {
        ...
        try {
            ...
            if (!fileInIsEmpty()) {
                ...
                MyHashMap<Byte, Byte[]> byteMap = tree.getMap(root);
     ...
     */
    private void writePack(FileInputStream inputStream, BufferedOutputStream outputStream, MyHashMap<Byte, Byte[]> byteMap) throws IOException {
     ...
     */
    private MyHashMap<Byte, Integer> getUniqueBytesFrequency() throws IOException {
        MyHashMap<Byte, Integer> byteMap = new MyHashMap<>();
