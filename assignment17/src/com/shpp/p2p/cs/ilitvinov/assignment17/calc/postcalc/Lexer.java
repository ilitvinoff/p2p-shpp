...
public class Lexer {
    ...
    public static MyList<Token> tokenize(String expression) throws Exception {
        int index = 0;
        MyList<Token> tokens = new MyArrayList<>();
     ...
     * @param tokens - MyList<Token> where to add token
     ...
     * */
    private static int tokenizeNumber(MyList<Token> tokens, String searchIn) throws Exception {
    ...
    /**Defines if expression is variable or function and adds the appropriate token to MyList
     * @param tokens - MyList<Token> where to add token
     ...
     * */
    private static int tokenizeLetter(MyList<Token> tokens, String searchIn) throws Exception {
    ...
    private static boolean tokenizeFunction(MyList<Token> tokens, String searchIn) {
    ...
    /**Defines which arithmetic operation is. Add it to token's MyList
     * @param tokens - MyList<Token> where to add token
     * @param operation - char which includes operation */
    private static void tokenizeOperation(MyList<Token> tokens, char operation) {
