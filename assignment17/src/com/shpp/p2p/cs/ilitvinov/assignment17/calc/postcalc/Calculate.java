...
import com.shpp.p2p.cs.ilitvinov.assignment17.calc.postcalc.ast.Expression;
...
public class Calculate {
    private final MyList<Expression> nodes;
    private final MyHashMap<String, Double> variables;

    /**@param  nodes - MyList<Expression>
     * @param  variables - HashMap<String name, Double value>*/
    public Calculate(MyList<Expression> nodes, MyHashMap<String, Double> variables) {
        this.nodes = nodes;
    ...
    public Calculate(MyList<Expression> nodes, MyHashMap<String, Double> variables, String[] args) throws Exception {
        this.nodes = nodes;
        this.variables = variables;
